 ...
 */
final class Version20240531133957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_chapter (id INT NOT NULL, book_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, sort INT DEFAULT 0 NOT NULL, level INT NOT NULL, PRIMARY KEY(id))');
