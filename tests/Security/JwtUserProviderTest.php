...
class JwtUserProviderTest extends AbstractTestCase
{
    ...
    {
        $user = (new User())->setEmail('test@test.com')->setId(123);
        ...
        $this->assertEquals($user, $provider->loadUserByIdentifierAndPayload('test@test.com', ['id' => 123]));
    }
    ...
    public function testLoadUserByIdentifierAndPayloadNotFoundException(): void
    {
        ...
        (new JwtUserProvider($this->userRepository))->loadUserByIdentifierAndPayload('test@test.com', ['id' => 123]);
    }
}
